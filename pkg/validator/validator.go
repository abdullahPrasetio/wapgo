...
// Validator wraps go-playground/validator with helpers.
type Validator struct {
	v *validator.Validate
}

// New creates a Validator instance with sane options.
func New() *Validator {
	v := validator.New()
...
// Validate validates a struct and returns a human-readable error or nil.
